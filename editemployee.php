...
while($post=mysqli_fetch_assoc($record)) {
   ...
   ?>
      ...
      <tr>
		...
		<td><input type="date" name="dateofbirth" class="form-control" id="formGroupExampleInput" value="<?php echo $post['DOB']; ?>" placeholder="name"></td></td>
		...
		<td><input type="select" name="department" class="form-control" id="formGroupExampleInput" value="<?php echo $post['department']; ?>" placeholder="name"> 
