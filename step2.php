	...
	<div class="wrapper">
		<form action="" method="post" name="Login_Form" class="form-signin">       
		    <h3 class="form-signin-heading">Step 2:</h3>
			  ...
			  <input type="password" class="form-control1 form-control inputlogintext" name="password" placeholder="password" required="" autofocus="" />
			  <br>
			  <label>Confirm Password:</label>
			  <input type="password" class="form-control1 form-control inputloginpass" name="confirm_password" placeholder="confirm Password" required=""/>  <br>   		  
